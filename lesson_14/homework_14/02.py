...
#
# test_addition: Тестирование операции сложения. Создайте два прямоугольника: один с шириной 5, другой
# с шириной 3 и высотой 4. Выполните операцию сложения r1 + r2 и убедитесь, что полученный прямоугольник
...
class TestRectangle(unittest.TestCase):
    def setUp(self):
        self.rect = Rectangle(5)
        self.rect_2 = Rectangle(3, 4)

    def test_width(self):
        self.assertEqual(self.rect.width, 5)

    def test_height(self):
        self.assertEqual(self.rect_2.height, 4)

    def test_perimeter(self):
        self.assertEqual(self.rect.perimeter(), 20)

    def test_area(self):
        self.assertEqual(self.rect_2.area(), 12)

    def test_addition(self):
        new = self.rect + self.rect_2
        self.assertEqual(new.width,8)
        self.assertEqual(new.height,6.0)
