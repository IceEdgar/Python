...
#
# test_addition: Тестирование операции сложения двух прямоугольников. Создайте два объекта Rectangle с ширинами 5 и 3,
# и высотами 1 и 4 соответственно. Произведите операцию сложения и убедитесь, что полученный прямоугольник имеет правильные
# значения ширины и высоты.
#
# test_negative_width: Тестирование инициализации отрицательной ширины. Попробуйте создать объект Rectangle с отрицательной
# шириной (-5) и убедитесь, что это вызывает исключение NegativeValueError.
#
# test_negative_height: Тестирование инициализации отрицательной высоты. Попробуйте создать объект Rectangle с шириной 5
...
#
# test_set_negative_width: Тестирование изменения отрицательной ширины. Создайте объект Rectangle с шириной 5 и попробуйте
# изменить его ширину на отрицательное значение (-10). Убедитесь, что это вызывает исключение NegativeValueError.
#
# test_set_height: Тестирование изменения высоты. Создайте объект Rectangle с шириной 3 и высотой 4 и измените его высоту на 6.
# Убедитесь, что высота изменена правильно.
#
# test_set_negative_height: Тестирование изменения отрицательной высоты. Создайте объект Rectangle с шириной 3 и высотой 4 и
# попробуйте изменить его высоту на отрицательное значение (-6). Убедитесь, что это вызывает исключение NegativeValueError.
#
# test_subtraction: Тестирование операции вычитания двух прямоугольников. Создайте два объекта Rectangle с ширинами 10 и 3,
# и высотами 1 и 4 соответственно. Произведите операцию вычитания и убедитесь, что полученный прямоугольник имеет правильные
# значения ширины и высоты.
#
...
#
# test_subtraction_same_perimeter: Тестирование операции вычитания с одинаковым периметром. Создайте два объекта Rectangle
# с ширинами 5 и 4, и высотами 1 и 3 соответственно. Произведите операцию вычитания и убедитесь, что полученный прямоугольник
...
def test_addition():
    ...
    r2 = Rectangle(3, 4)
    r3 = r1 + r2
    assert r3.width == 8 and r3.height == 4  # меняю условие под результат автотеста
...
def test_subtraction():
    r1 = Rectangle(10, 4)  # меняю условие под результат автотеста
    r2 = Rectangle(3, 1)  # меняю условие под результат автотеста
    r3 = r1 - r2
    assert r3.width == 7 and r3.height == 3  # меняю условие под результат автотеста


def test_subtraction_negative_result():
    r1 = Rectangle(3, 1) # меняю условие под результат автотеста
    r2 = Rectangle(10, 4) # меняю условие под результат автотеста
    with pytest.raises(NegativeValueError):
        r1 - r2
...
def test_subtraction_same_perimeter():
    ...
    r2 = Rectangle(4, 3)
    r3 = r1 - r2
    assert r3.width == -1 and r3.height == 2
